...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="textLeft" style="margin-top: 5px">
					<a class="headBarText" href="index.jsp" title="DiscussThing"><img
						class="headBarImage"
						src="Entities/default/pictures/logo-removebg-preview.png"> </a>
	...
	<meta charset="ISO-8859-1">
	<h5 align="center">
		<font color=287650><strong>Your Post has been
				submitted</strong></font>
	</h5>
	...
	<div id="category_1" class="row messageBoard messageMargin">
		<a href="#" onclick="showDiscussion(1);">
			<div class="col-lg-12 columnPad">
				<div class="textLeft">
					<h3>Click here to see DiscussThings</h3>
					<div class="textLeft">
						<a class="btn btn primary btn-sm entityButton" href="index.jsp"
							title="DiscussThing"
							style="margin-top: 7px; margin-right: -50px;">Home</a>
					</div>
				</div>
		...
		<div class="col-lg-12">
			<table class="messageTable">
				...
				<thead>
					...
					<th class="textRight" style="margin-right: -720px";>Description</th>
				</thead>
				<%
					try {
		...
		<div class="col-lg-12">
			<form action="ViewProfile" method="post">
				<div class="form-group">
					<textarea class="newDiscussion form-control" name="newDiscussion_1"
						rows="10" cols="50"></textarea>
					<input class="class="btn btn-primary btn-sm entityButton" style="font-weight: 200; margin-top: 10px;" type="submit"
						value="Reply" style="margin-top: 10px;">
				</div>
			</form>
		</div>
	</div>
